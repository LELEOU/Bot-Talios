"""
Log Channel Delete - Registra exclusão de canais
"""
...
class LogChannelDelete(commands.Cog):
    ...
    async def on_guild_channel_delete(self, channel):
        try:
            ...
            embed = discord.Embed(
                title="🗑️ Canal Deletado", color=0xFF0000, timestamp=discord.utils.utcnow()
            )
            ...
            print(f"❌ Erro log canal deletado: {e}")
...
async def setup(bot):
    await bot.add_cog(LogChannelDelete(bot))
